...
let verticalGallery = [...document.querySelectorAll('.video-gallery')];

function startVerticalGallery() {
    if (!verticalGallery.length) {

    } else {
        verticalGallery.forEach((sld) => {
            let sldCont = sld.querySelector('.video-gallery__cont');
            let sldScrl = sld.querySelector('.navi');
            let sldPrev = sld.querySelector('.btn-sld--prev');
            let sldNext = sld.querySelector('.btn-sld--next');
